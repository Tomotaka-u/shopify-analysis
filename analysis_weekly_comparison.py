...
# === 期間設定 ===
THIS_WEEK_START = "2026-02-09"
THIS_WEEK_END = "2026-02-15"
LAST_WEEK_START = "2026-02-02"
LAST_WEEK_END = "2026-02-08"
...
def main():
    ...
    report_path = "output/weekly_report_20260215.md"
    ...
    with open("output/weekly_data_20260215.json", "w", encoding="utf-8") as f:
        json.dump(summary_data, f, ensure_ascii=False, indent=2, default=str)
    print(f"\nデータJSON保存: output/weekly_data_20260215.json")
